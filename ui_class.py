...
class MainScreen(Tk):
    def __init__(self):
        ...
        #self.config(padx=2, pady=2, bg=ORANGE)
        ...
        self.canvas = Canvas(self, width=466, height=196, bg=BACKGROUND, highlightthickness=0)
        self.logo = PhotoImage(file="logo.png")
        self.canvas.create_image(65, 100, image=self.logo)

        self.title_label = Label(text="Welcome to Password Manager!", font=("Courier", 13, "bold"), fg= "White", bg=BACKGROUND, highlightthickness=0)
        self.canvas.create_window(290, 30, window=self.title_label)

        self.wn_label = Label(text="Website:", font=("Courier", 11, "normal"), fg= "White", bg=BACKGROUND, highlightthickness=0)
        ...
        self.ue_label = Label(text="Email/User:", font=("Courier", 11, "normal"), fg= "White", bg=BACKGROUND, highlightthickness=0)
        ...
        self.pw_label = Label(text="Password:", font=("Courier", 11, "normal"), fg= "White", bg=BACKGROUND, highlightthickness=0)
